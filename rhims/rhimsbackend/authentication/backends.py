class StrictCaseModelBackend(ModelBackend):
    ...
    Use this in place of 'django.contrib.auth.backends.ModelBackend' in
    AUTHENTICATION_BACKENDS wherever exact-case login enforcement is
    required (e.g. the Django admin login form).
    """
